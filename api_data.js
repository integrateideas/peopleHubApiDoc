define({ "api": [
  ...
  },
  {
    ...
    "title": "redeem store credit of a user.",
    "description": "<p>This api is used to redeem store credit of a user.</p>",
    "version": "1.1.0",
    "name": "redeemUsersStoreCredit",
    "group": "Vendor_Apis",
    "header": {
      "fields": {
        "Header": [
        ...
        "Parameter": [
          {
            ...
            "optional": true,
            "field": "user_id",
            "description": "<p>User's Id. If sending user_id then attribute and attribute type should not be sent.</p>"
          },
          {
            "group": "Parameter",
            "type": "Integer",
            "optional": true,
            "field": "attribute",
            "description": "<p>value of attribute_type. If sending attribute and attribute type then user is should not be sent.</p>"
          },
          {
            "group": "Parameter",
            "type": "Integer",
            ...
            "description": "<p>it can be phone or email or card only</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "reward_type",
            "description": "<p>it should be store_credit.</p>"
          }
        ]
      },
      "examples": [
